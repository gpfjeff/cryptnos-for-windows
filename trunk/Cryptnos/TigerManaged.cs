...
{
    public class TigerManaged : HashAlgorithm
    {
        ...
        * message digest.
        */
        //public TigerManaged(TigerManaged t)
        //{
        //    a = t.a;
        //    b = t.b;
        //    c = t.c;
        ...
        */
        ...
        // as 1 by default; Tiger uses a block size of 1024.  So we need to override these
        ...
        protected override byte[] HashFinal()
        {
            ...
            byte[] theHash = new byte[DigestLength];
            DoFinal(theHash, 0);
            return theHash;
        }
